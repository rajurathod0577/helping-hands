...
function getConfigDir() {
    ...
    if (platform === 'win32') {
        configDir = path.join(os.homedir(), 'AppData', 'Roaming', 'helping-hands-config');
    } else if (platform === 'darwin') {
        configDir = path.join(os.homedir(), 'Library', 'Application Support', 'helping-hands-config');
    } else {
        configDir = path.join(os.homedir(), '.config', 'helping-hands-config');
    }
