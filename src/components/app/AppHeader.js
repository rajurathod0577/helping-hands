...
export class AppHeader extends LitElement {
    ...
    async _checkForUpdates() {
        try {
            const currentVersion = await helpingHands.getVersion();
    ...
    getViewTitle() {
        const titles = {
            onboarding: 'Welcome to Helping Hands',
            main: 'Helping Hands',
            customize: 'Customize',
            help: 'Help & Shortcuts',
            history: 'Conversation History',
            advanced: 'Advanced Tools',
            assistant: 'Helping Hands',
        };
        return titles[this.currentView] || 'Helping Hands';
    }
                    ...
                    ${this.currentView === 'assistant'
                        ? html`
                              <button @click=${this.onHideToggleClick} class="button">
                                  Hide&nbsp;&nbsp;<span class="key" style="pointer-events: none;">${helpingHands.isMacOS ? 'Cmd' : 'Ctrl'}</span
